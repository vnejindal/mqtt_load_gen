...
time sudo docker run -d -t --rm -e TOOL_SINDEX=${TOOL_SINDEX} -e TOOL_EINDEX=${TOOL_EINDEX} -w ${WORKDIR} -v ${HOST_VOL_PATH}:${DOCKER_VOL_PATH} --sysctl=net.ipv4.ip_local_port_range="2000 65535" load_test_vne:0.1
